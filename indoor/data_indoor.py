...
class indoor3d_dataset(data.Dataset):
    def __init__(self, datalist_path, test_area='Area_6',training=True):
        self.datalist = datalist_path
        self.test_area=test_area

        self.pts,self.seg_label=load_cls(self.datalist)
...
if __name__ == '__main__':
    dataset=indoor3d_dataset(datalist_path='../../3d_data/indoor3d_sem_seg_hdf5_data/all_files.txt')
